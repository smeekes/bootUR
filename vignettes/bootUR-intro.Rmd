...
We illustrate the ADF test here on Dutch GDP for both the two-step and one-step specification, each time including a linear trend in the specification.
