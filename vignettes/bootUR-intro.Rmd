...
boot_sqt(MacroTS, SQT_level = 0.05, steps = 0:N, bootstrap = "AWB", B = 399)
# Split in four equally sized groups (motivated by the 4 series per country)
boot_sqt(MacroTS, SQT_level = 0.05, steps = 0:4 / 4, bootstrap = "AWB", B = 399)
```
...
```{r bFDR}
N <- ncol(MacroTS)
boot_fdr(MacroTS[, 1:10], FDR_level = 0.1, bootstrap = "BWB", B = 399)
```
