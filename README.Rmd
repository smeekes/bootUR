...
<!-- badges: start -->
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version-last-release/bootUR)](https://cran.r-project.org/package=bootUR)
...
```
When installing from GitHub, in order to build the package from source, you need to have the apprpriate R development tools installed (such as [Rtools](https://cran.r-project.org/bin/windows/Rtools/) on Windows.)
